...
function DestinationsContainer() {
  const destinations = [
    ...
    { name: "Rome", image: rome, price:100,date:"10/05/2024",status:"aller" },
    { name: "Maldives", image: maldives, price:100,date:"10/05/2024",status:"aller" },
    { name: "Bali", image: bali, price:100,date:"10/05/2024",status:"aller" },
